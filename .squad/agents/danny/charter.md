...
- System architecture decisions and architecture decision records (ADRs) for the blog platform
- Technology stack selection and evaluation (Jekyll, Chirpy, Ruby, Python toolchain)
- Cross-cutting concerns: permalink structure, URL preservation from WordPress, build integrity
- Long-term technical roadmap and technical debt strategy (migration completeness, content quality)
